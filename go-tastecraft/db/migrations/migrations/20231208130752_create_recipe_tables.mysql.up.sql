...
CREATE TABLE nutritional_values (
  ...
  proteins DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  carbohydrates DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  fat DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  fiber DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  calcium DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  iron DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  zinc DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_a DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_b DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_b1 DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_b2 DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_b3 DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_b6 DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_b12 DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_c DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_d DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_e DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  vitamin_k DECIMAL(10,3) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (id),
  INDEX food_id_idx (food_id ASC) VISIBLE,
  CONSTRAINT food_nutritional_value_id
    FOREIGN KEY (food_id)
    REFERENCES foods (food_id)
    ON DELETE CASCADE
    ON UPDATE CASCADE
